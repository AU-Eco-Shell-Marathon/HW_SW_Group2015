...
It should be noted that the system is designed to work with AU2 and "NAME OF GUI"\fxnote{name of GUI}. These a threated as seperate systems and it is recommended that the reader reads their documentation, in order to get a complete overview the systems.
...
During the test the system will collect data from the test-drive and send them to the "NAME OF GUI"\fxnote{name of GUI} where they will be displayed graphically. The user is also able to regulate the amount of torque required to spin the roll in dynamometer, by using this GUI.
