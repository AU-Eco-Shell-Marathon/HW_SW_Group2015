...
\begin{itemize}
	\item \textbf{AU2}\\
	Refers to the car which is being developed simultaneously as the dynamometer.
	\item \textbf{GUI}\\
	Refers to the Rolling Road GUI which must be connected to Rolling Road for visual representation of the measured data.
	\item \textbf{Load}\\
