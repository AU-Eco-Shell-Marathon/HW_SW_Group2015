...
\subsection{Sensor} \fxnote{What, "Sensor" er alt for generic, hver sensor ude fra burde have deres egen 'klasse' med deres egen 'driver'. Hvis vi skal ændre en sensor nu, skal der alt for meget til - JH}
