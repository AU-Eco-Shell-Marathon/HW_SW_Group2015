...
There is somethings that is dangerous. \\ \fxnote{Omformuler det næste stykke - JH}
...
\lstset{language=C}\fxnote{Hvis de vil se implementationen kan de gå ind i kilde koden - JH}
\begin{lstlisting}
