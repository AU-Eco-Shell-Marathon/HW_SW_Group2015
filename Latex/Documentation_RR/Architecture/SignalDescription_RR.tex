...
\fxnote{Vil ikke mene det er nødvendigt med en direction på hver (Eller hvis det skal være der, burde det bare være IN, OUT osv.) - JH}

\fxnote{Alle signaler skal vel have spænding eller lign. info (Det virker lidt tilfældigt om de har eller ej) - JH}
