...
\fxnote{Farverne er afhængige af det kabel der bruger, så link til et hvis muligt - JH}
\begin{table}[h]
	\centering
	\label{my-label}
...
\textbf{Angular velocity}\\ \fxnote{ Vil det give mening at forklare om hvad forskellen på de 2 outputs er til de næste? TN}
...
The Torque Sensor hasn't had a unity \fxnote{Det er nok bare at refer til testen - JH} test since this was done in the Previous System\cite{BAC_rullefelt}. For a complete unit test of the sensor, the reader is referred to the related documentation on page 49 to 51.