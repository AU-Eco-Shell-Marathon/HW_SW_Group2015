...
The amount of current consumed by the 5 VDC line is calculated in \vref{sec:LevelConverter} \fxnote{reference mangler} and will not be examined in this section. The amount of current consumed is calculated as:
\begin{equation}
...
\end{figure}
\fxnote{Burde fusen ikke være før opsplittelsen af signalet? - TN}
