...
The Voltage Adaptor is implemented using a \fxnote{name of voltage adaptor}. The adaptor connects the Control-box with the electrical mains with a 5V coaxial plug. \fxnote{reference}
