...
\begin{longtable}{|p{1.6 cm}|p{2.9 cm}|p{2.9 cm}|p{1.9 cm}|p{1.8 cm}|p{1.8 cm}|}
	...
	& Connect a powersource which is emitting 40 A and short circuit the speakon connector. Test the output of BMS with a multimeter, when the emergency switch is pressed. (Replace the fuse with a new one after the test of this requirement.)
	& The multimeter shows 0 V $\pm$0.5 V.
