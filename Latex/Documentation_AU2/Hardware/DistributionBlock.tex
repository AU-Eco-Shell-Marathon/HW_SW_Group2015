...
There are various resistors can be changed and thereby change the different things e.g. the output voltage.\fxnote{omformuler} 
...
There have been tested extensively on this module. All the tests have come up with at negative response. \fxnote{resultat af test skal stå bagefter testudførelse}
