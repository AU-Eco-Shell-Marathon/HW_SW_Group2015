...
It has been chosen to use the LT8300 Isolated Flyback Converter from Linear Technology. The implementation is done almost according to the datasheet \fxnote{husk ref} except there is implemented a snubbercircuit and a decoupling before the transformer. Furthermore the values of the resistors is changed.  \\
