...
A change to that was spotted on the Battery Monitor IC was that two capacitors were connected from pin 49 and 50 on the IC and then each one separately to R60 and R61. This change is limited to the Analog Front End and is not found on the Analog Front End Extension Module.
