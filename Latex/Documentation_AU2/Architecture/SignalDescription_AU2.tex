...
\begin{itemize}
	...
	Description: Power consumed by the motor. This connection is only relevant when AU2 is connected to Rolling Road. \fxnote{Er ikke i IBD!!!}
	...
	Direction: [Propulsion Motor] $\rightarrow$ [External]\\
	Description: The force the Propulsion Motor has. \fxnote{Er ikke i IBD!!!}
	...
	Description: When the button is pressed, a signal is sent to the Motor Control System to engage the coast-and-burn driving algorithm. \fxnote{Er ikke i IBD, men der er en ON/OFF button!!!}
...
\begin{itemize}
	...
	Direction: [Motor Control System] \& [Battery Management System] $\leftrightarrow$ [Computer]\\
	Description: CAN-communication with either the Motor Control System or the Battery Management System in order to gain information about various variables and to calibrate the system.
\end{itemize}