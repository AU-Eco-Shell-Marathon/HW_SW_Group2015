...
\begin{itemize}
	...
	Description: Can be triggered by pressing a button on the vehicle's frame or by releasing the Deadmans Switch inside the cockpit.	
...
\begin{itemize}
	...
	\item \textbf{OUT:ESignal}\\  \fxnote{Enten ESignal eller ESsignal}
