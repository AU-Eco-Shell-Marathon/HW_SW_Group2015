...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Distribution Block}\\ \fxnote{Eventuel omdøbning til switch mode power supply - JOnathan}
	...
	\begin{itemize}
		...
		\item \textbf{Joulemeter}\\ \fxnote{evt. omformulering - JOnathan}
