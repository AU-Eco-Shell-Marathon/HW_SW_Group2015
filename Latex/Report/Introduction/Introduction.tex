...
The report and all of the documentation has been written in English to keep it coherent with previous documentations\fxnote{er dokumentationen skrevet på engelsk for at være sammenhængig med sig selv? - TR}. Also, the techincal documentation which was required to be delivered to Shell for the technical inspection of the car, therefore it was easier and more convenient to be able to copy/paste from this report and the associated documents.\fxnote{omformuler -TR}
