...
\begin{itemize}
	...
	\item \textbf{PSoC}\\
	Refers to the CY8CKIT-059 PSoC 5LP Prototype Kit which is used to build the Control Unit in Rolling Road and the Motor Controller in AU2.\item \textbf{Motor Control System}\\
	Refers to the entire PCB made to control AU2. 
	\item \textbf{Zenith33}\\
...
\begin{tabular}[c]{|p{3cm}| p{5cm} | p{6cm}|}
	...
	%Thomas N
	\phantom{Test}
	\includegraphics[width=3cm]{Introduction/TeamPictures/ThomasN} & \multirow{2}{5cm}{Hardware development for Motor Control system \newline \newline Protocol development for RR} & \multirow{2}{6cm}{I have been responsible for the design and implementation of the hardware for MCS. Furthermore I have developed the Protocol for Rolling Road} \\
