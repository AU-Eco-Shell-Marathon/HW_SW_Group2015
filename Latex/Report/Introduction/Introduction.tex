...
This report and the corresponding documentation with its appendix is written as the documentation of the development process of the AU2 car, the dynamo-meter dubbed Rolling Road and the GUI developed for use with the Rolling Road. The products being developed are made to compete in the Shell Eco Marathon. The development process is accomplished in correlation with Aarhus School of Engineering (ASE) as the 4\textsuperscript{th} term project. This means that the report covers three major systems:
...
Throughout the work with developing this car, there have been many hours collaborating with the mechanical engineers who are responsible for designing and building the car's body. The interdisciplinary work with the mechanical engineers have made this a rather large project and therefore required cross-group project-management; which was absent for large parts of the project. 

The report and all of the documentation has been written in English to keep it coherent with previous documentations\fxnote{er dokumentationen skrevet på engelsk for at være sammenhængig med sig selv?}. Also, the techincal documentation which was required to be delivered to Shell for the technical inspection of the car, therefore it was easier and more convenient to be able to copy/paste from this report and the associated documents.\fxnote{omformuler}
...
\begin{tabular}[c]{|p{3cm}| p{5cm} | p{6cm}|}
	...
	% Jens
	\phantom{Test}
	\includegraphics[width=3cm]{Introduction/TeamPictures/Jens} & \multirow{2}{5cm}{Project leader and communication coordinator.\newline \newline System architecture for Battery Management System.\newline \newline Hardware and software developer on AU2's Battery Management System.} & \multirow{2}{6cm}{As the project leader I have been responsible for all the different small tasks such as meeting invitations, meeting moderator and communicating with the mechanical engineering team.\newline \newline I've been responsible for creating the system-description and system-architecture of the Battery Management System.\fxnote{HOLY TITTY-FUCKING CHRIST! mit latex dun goofed her}\newline \newline Lastly I am responsible for understanding the Battery Management System.} \\
	Jens P. Nymann & & \\ \hline
