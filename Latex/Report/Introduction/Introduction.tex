...
\section{List of terms}\fxnote{maybe add BMS and MCS as well... LB}
...
\begin{itemize}
	\item \textbf{AU2}\\
	AU2 is the newest car to be made to compete in the SEM.	\fxnote{is the electrical system or the car..... some means one others mean the other LB}
	\item \textbf{SEM}\\
