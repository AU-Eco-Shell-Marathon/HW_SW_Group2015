...
The Onion Architecture heavily uses the repository pattern to abstract away from the data source \fxnote{Omformuler, abstract away lyder forkert}, making it easy to change the data source to a database for example. If later in the process, the website user story was to be implemented\fxnote{Omformuler fra punktum hertil} it would require little or no change to the back-end.
