...
\section{AU2}
The MCU(Motor control unit) \fxnote{skal det ikke være MCS?}can be seen in figure \vref{fig:SD_MCS} without the PSoC.\fxnote{med så stor beskrivelse af BMS, så kan vi vel også beskrive MCS lidt bedre}
