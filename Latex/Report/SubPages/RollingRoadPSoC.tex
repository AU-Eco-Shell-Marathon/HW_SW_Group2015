...
\subsection{Design}
The rolling road a made in c but are written in a more object form to look like c++ more. Because of that it is easier to design it as a objective program. To design the solution a class diagram was made see Rolling road doc\fxnote{lav reference}.\\
...
%\begin{figure}[H] \fxnote{Jeg kan ikke compile pga den der includegraphics...}
%	\centering
