...
\textbf{Atmel Studio Version 4, 6 and 7}\fxnote{Skal lige spørge Laimonas om. fordi version 4 er faktisk kaldet AVR Studio}\\ 
Used to compile, program and debug the BMS.

\textbf{Visual Studio}\\
TEKST.\fxnote{Visual Studio skal også indskrives, men hvad version er det helt præcist?}
