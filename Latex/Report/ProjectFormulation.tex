...
The dynamometer is a build on of a previous system with similar functionality\fxnote{reference} and much of the design-parameters has been re-used. The new dynamometer has been dubbed \textbf{Rolling Road} and is also part of the project.
