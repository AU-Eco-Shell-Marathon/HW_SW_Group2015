...
void DMA_init()
{
    ...
    CyDmaTdSetConfiguration(DMA_A_TD[0], 2, CY_DMA_DISABLE_TD, TD_INC_SRC_ADR | TD_INC_DST_ADR);
    ...
    CyDmaTdSetConfiguration(DMA_V_TD[0], 2, CY_DMA_DISABLE_TD, TD_INC_SRC_ADR | TD_INC_DST_ADR);
