...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000960u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x4800097Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG6_CFG0), 0x01F3u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW3, 0x41u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW0, 0xB0u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW3, 0x20u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP0_MX, 0x0220u);
