// ======================================================================
// RollingGoal.v generated from TopDesign.cysch
// 02/26/2016 at 19:45
...
module ADC_SAR_v3_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("6890f846-264e-4659-864c-f320bf404caf/dea208d9-07b0-438b-a5e0-ac5d207f2658/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_SEQ_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("6890f846-264e-4659-864c-f320bf404caf/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("592592592.592593"),
		  .is_direct(0),
		  .is_digital(1))
		IntClock
		 (.clock_out(Net_3874));
	...
	cy_clock_v1_0
		#(.id("6890f846-264e-4659-864c-f320bf404caf/3d23b625-9a71-4c05-baf4-2f904356009b"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=1, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Comp_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_1, CY_INSTANCE_SHORT_NAME=Comp_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=Comp_1, )
module Comp_v2_0_3 (
    Vplus,
    CmpOut,
    Vminus,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_1, CY_INSTANCE_SHORT_NAME=VDAC8_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=VDAC8_1, )
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0\cy_srff_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0\cy_srff_v1_0.v"
`endif

// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1170000, ADC_Input_Range=4, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=5, Ref_Voltage_mV=5000, rm_int=false, Sample_Precharge=6, Sample_Rate=65000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v3_0_6 (
	...
	cy_clock_v1_0
		#(.id("00440151-906b-4bf1-aef0-887fb5ab951a/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("854700854.700855"),
		  .is_direct(0),
		  .is_digital(1))
		theACLK
		 (.clock_out(Net_376));
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967295, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=Counter_1, )
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`else
`define CY_BLK_DIR "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90"
`include "D:\Program Files (x86)\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`endif

// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967295, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_2, CY_INSTANCE_SHORT_NAME=Counter_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=Counter_2, )
...
module top ;
          ...
          wire  Net_10813;
          wire  Net_10812;
    electrical  Net_10787;
          wire  Net_10305;
    electrical  Net_10304;
          wire  Net_10303;
          wire  Net_9135;
          wire  Net_10302;
          wire  Net_10803;
	...
	cy_clock_v1_0
		#(.id("2e08eca4-2c79-4694-af39-6a5f85453ebf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__V_motor_net;
	wire [0:0] tmpFB_0__V_motor_net;
	wire [0:0] tmpIO_0__V_motor_net;
	wire [0:0] tmpINTERRUPT_0__V_motor_net;
	electrical [0:0] tmpSIOVREF__V_motor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		V_motor
		 (.oe(tmpOE__V_motor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_motor_net[0:0]}),
		  .analog({Net_209}),
		  .io({tmpIO_0__V_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__V_motor_net),
		  .interrupt({tmpINTERRUPT_0__V_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__A_motor_net;
	wire [0:0] tmpFB_0__A_motor_net;
	wire [0:0] tmpIO_0__A_motor_net;
	wire [0:0] tmpINTERRUPT_0__A_motor_net;
	electrical [0:0] tmpSIOVREF__A_motor_net;

	cy_psoc3_pins_v1_10
		#(.id("ee98b79c-f58c-46cd-85ec-79f50e5dedb7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		A_motor
		 (.oe(tmpOE__A_motor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__A_motor_net[0:0]}),
		  .analog({Net_210}),
		  .io({tmpIO_0__A_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__A_motor_net),
		  .interrupt({tmpINTERRUPT_0__A_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Moment_net;
	wire [0:0] tmpFB_0__Moment_net;
	wire [0:0] tmpIO_0__Moment_net;
	wire [0:0] tmpINTERRUPT_0__Moment_net;
	electrical [0:0] tmpSIOVREF__Moment_net;

	cy_psoc3_pins_v1_10
		#(.id("0296292c-5937-45db-915f-31d5c0d3dd65"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Moment
		 (.oe(tmpOE__Moment_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Moment_net[0:0]}),
		  .analog({Net_9263}),
		  .io({tmpIO_0__Moment_net[0:0]}),
		  .siovref(tmpSIOVREF__Moment_net),
		  .interrupt({tmpINTERRUPT_0__Moment_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Moment_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__A_generator_net;
	wire [0:0] tmpFB_0__A_generator_net;
	wire [0:0] tmpIO_0__A_generator_net;
	wire [0:0] tmpINTERRUPT_0__A_generator_net;
	electrical [0:0] tmpSIOVREF__A_generator_net;

	cy_psoc3_pins_v1_10
		#(.id("da083974-0775-469a-8358-473b6c5cc625"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		A_generator
		 (.oe(tmpOE__A_generator_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__A_generator_net[0:0]}),
		  .analog({Net_7985}),
		  .io({tmpIO_0__A_generator_net[0:0]}),
		  .siovref(tmpSIOVREF__A_generator_net),
		  .interrupt({tmpINTERRUPT_0__A_generator_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A_generator_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("d64614b6-a33e-45c7-a4dd-e8daea0884be"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("195312500"),
		  .is_direct(0),
    ...
    assign Net_1689 = Net_10655 & Net_1495;

    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_9965)
    begin
        cy_srff_1 <= (Net_1240 | Net_1511) & ~Net_1241;
    end
    assign Net_1511 = cy_srff_1;
    // -- SRFF End --


    assign Net_10655 = ~Net_1511;

	wire [0:0] tmpOE__PWM_belastning_net;
	wire [0:0] tmpFB_0__PWM_belastning_net;
	wire [0:0] tmpIO_0__PWM_belastning_net;
	wire [0:0] tmpINTERRUPT_0__PWM_belastning_net;
	electrical [0:0] tmpSIOVREF__PWM_belastning_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_belastning
		 (.oe(tmpOE__PWM_belastning_net),
		  .y({Net_1689}),
		  .fb({tmpFB_0__PWM_belastning_net[0:0]}),
		  .io({tmpIO_0__PWM_belastning_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_belastning_net),
		  .interrupt({tmpINTERRUPT_0__PWM_belastning_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_belastning_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("6678415c-99ad-4969-96eb-58884720121d"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    assign Net_9738 = 1'h1;

    assign Net_9943 = 1'h0;
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		isr_3
		 (.int_signal(Net_10774));



	cy_clock_v1_0
		#(.id("9dc2e243-0884-4ef1-a5fb-755a539da598"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		isr_4
		 (.int_signal(Net_10833));



	cy_clock_v1_0
		#(.id("5cfbe493-d6bc-40fe-9302-a236c2c0e98c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000000"),
		  .is_direct(0),
    ...
    assign Net_10855 = 1'h0;

    assign Net_10865 = 1'h1;
