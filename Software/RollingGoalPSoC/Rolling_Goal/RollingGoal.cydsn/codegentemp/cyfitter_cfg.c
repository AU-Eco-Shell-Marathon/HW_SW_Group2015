...
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)0x48000974u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800098Cu)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x480009A0u)
